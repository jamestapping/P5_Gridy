...
extension PlayBoardViewController: GridyBrainDelegate {
            ...
            self.openAlert(title: "Gridy",
                           ...
                           actions: [
                            ...
                            { [self]_ in
                                ...
                                let activityVC = UIActivityViewController(activityItems: [recievedImage!, "I completed this #Gridy puzzle in \(moves) moves, \(timePassedText). Can you do better? :)"], applicationActivities: nil)
